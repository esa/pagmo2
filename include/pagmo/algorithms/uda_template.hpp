...
#ifndef PAGMO_ALGORITHMS_ALGO_NAME_HPP
#define PAGMO_ALGORITHMS_ALGO_NAME_HPP
...
public:
     ...
     */
    ALGO_NAME(unsigned int gen = 1u, unsigned int seed = pagmo::random_device::next())
     ...
     * <tt> std::vector </tt> is a ALGO_NAME::log_line_type containing: Gen, Fevals, Best, Improvement, Mutations as
     * described
     * in ALGO_NAME::set_verbosity
     * @return an <tt> std::vector </tt> of ALGO_NAME::log_line_type containing the logged values Gen, Fevals, Best,
...
private:
    ...
    // Common to all stochastic
    mutable detail::random_engine_type m_e;
    unsigned int m_seed;
    // Common to all logging udas
...
PAGMO_REGISTER_ALGORITHM(pagmo::ALGO_NAME)
