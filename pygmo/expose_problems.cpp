...
void expose_problems()
{
    ...
    // Test problem.
    auto test_p = expose_problem<test_problem>("_test_problem", "A test problem.");
    ...
    expose_problem<tu_test_problem>("_tu_test_problem", "A thread unsafe test problem.");
    // Null problem.
    auto np = expose_problem<null_problem>("null_problem", null_problem_docstring().c_str());
    ...
    // Ackley.
    auto ack = expose_problem<ackley>("ackley", "__init__(dim = 1)\n\nThe Ackley problem.\n\n"
    ...
    // Griewank.
    auto griew = expose_problem<griewank>("griewank", "__init__(dim = 1)\n\nThe Griewank problem.\n\n"
...
// reassesed in future versions of the compiler
#if !defined(_MSC_VER)
    // CEC 2013.
    auto cec2013_ = expose_problem<cec2013>("cec2013", cec2013_docstring().c_str());
    ...
    // CEC 2009
    auto cec2009_ = expose_problem<cec2009>("cec2009", cec2009_docstring().c_str());
