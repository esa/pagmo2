...
void expose_algorithms()
{
    ...
    mbh_.def("__init__", bp::make_constructor(
                             lcast([](const algorithm &a, unsigned stop, const bp::object &perturb) {
    ...
    mbh_.def("get_perturb", lcast([](const mbh &a) { return v_to_a(a.get_perturb()); }), mbh_get_perturb_docstring().c_str());
    ...
    de1220_.def("__init__", bp::make_constructor(
                                lcast([](unsigned gen, const bp::object &allowed_variants, unsigned variant_adptv,
