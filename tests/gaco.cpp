...
{
    g_aco user_algo{2u, 13u, 1.0, 0.0, 0.01, 1u, 1e-7, 7u, 2u, 1000u, 1000u, 0.0, 10u, 0.9, 23u};
    BOOST_CHECK(user_algo.get_verbosity() == 0u);
    BOOST_CHECK(user_algo.get_seed() == 23u);
    BOOST_CHECK((user_algo.get_log() == g_aco::log_type{}));

    BOOST_CHECK_THROW((g_aco{2u, 13u, 1.0, 0.0, -0.01, 1u, 1e-7, 7u, 2u, 1000u, 1000u, 0.1, 10u, 0.9, 23u}),
                      std::invalid_argument);
    BOOST_CHECK_THROW((g_aco{2u, 13u, 1.0, 0.0, 0.01, 1u, 1e-7, 7u, 2u, 1000u, 1000u, -0.1, 10u, 0.9, 23u}),
                      std::invalid_argument);
    BOOST_CHECK_THROW((g_aco{2u, 13u, 1.0, 0.0, 0.01, 1u, 1e-7, 7u, 2u, 1000u, 1000u, 0.0, 10u, -0.1, 23u}),
                      std::invalid_argument);
    BOOST_CHECK_THROW((g_aco{2u, 13u, 1.0, 0.0, 0.01, 1u, 1e-7, 7u, 2u, 1000u, 1000u, 0.0, 10u, 1.1, 23u}),
                      std::invalid_argument);
    BOOST_CHECK_THROW((g_aco{2u, 13u, 1.0, 0.0, 0.01, 1u, 1e-7, 7u, 3u, 1000u, 1000u, 0.0, 10u, 0.9, 23u}),
                      std::invalid_argument);
    BOOST_CHECK_THROW((g_aco{2u, 13u, 1.0, 0.0, 0.01, 1u, 1e-7, 7u, 0u, 1000u, 1000u, 0.0, 10u, 0.9, 23u}),
                      std::invalid_argument);
    BOOST_CHECK_THROW((g_aco{2u, 13u, 1.0, 0.0, 0.01, 3u, 1e-7, 7u, 2u, 1000u, 1000u, 0.0, 10u, 0.9, 23u}),
                      std::invalid_argument);
    BOOST_CHECK_THROW((g_aco{2u, 13u, 1.0, 0.0, 0.01, 0u, 1e-7, 7u, 2u, 1000u, 1000u, 0.0, 10u, 0.9, 23u}),
                      std::invalid_argument);
}
...
BOOST_AUTO_TEST_CASE(evolve_test)
{
    ...
    // seed is controlled for all variants
    {
        ...
        for (unsigned int j = 1u; j <= 2u; ++j) {
            for (unsigned int i = 1u; i < 3u; ++i) {
                g_aco user_algo1{3u, 5u, 1.0, 1e9, 0.01, i, 1e-7, 7u, j, 1000u, 1000u, 0.0, 10u, 0.9, 23u};
                user_algo1.set_verbosity(1u);
                pop1 = user_algo1.evolve(pop1);

                BOOST_CHECK(user_algo1.get_log().size() > 0u);

                g_aco user_algo2{3u, 5u, 1.0, 1e9, 0.01, i, 1e-7, 7u, j, 1000u, 1000u, 0.0, 10u, 0.9, 23u};
                user_algo2.set_verbosity(1u);
                pop2 = user_algo2.evolve(pop2);

                BOOST_CHECK(user_algo1.get_log() == user_algo2.get_log());

                g_aco user_algo3{3u, 5u, 1.0, 1e9, 0.01, i, 1e-7, 7u, j, 1000u, 1000u, 0.0, 10u, 0.9, 23u};
    ...
    {
        g_aco user_algo{200u, 15u, 1.0, 0.0, 0.01, 150u, 1e-7, 7u, 2u, 1u, 1000u, 0.0, 10u, 0.9, 23u};
    ...
    {
        g_aco user_algo{200u, 15u, 1.0, 0.0, 0.01, 150u, 1e-7, 7u, 2u, 1000u, 1u, 0.0, 10u, 0.9, 23u};
        user_algo.set_verbosity(1u);
        problem prob{rosenbrock{2u}};
        population pop{prob, 20u, 23u};
        pop = user_algo.evolve(pop);
    ...
    {
        g_aco user_algo{200u, 150u, 1.0, 0.0, 0.01, 150u, 1.0, 7u, 2u, 1000u, 1000u, 0.0, 10u, 0.9, 23u};
        user_algo.set_verbosity(1u);
        problem prob{rosenbrock{2u}};
...
{
    g_aco user_algo{10u, 13u, 1.0, 0.0, 0.01, 9u, 1e-7, 7u, 2u, 1000u, 1000u, 0.0, 10u, 0.9, 23u};
...
BOOST_AUTO_TEST_CASE(serialization_test)
{
    ...
    algorithm algo{g_aco{10u, 13u, 1.0, 100.0, 0.01, 9u, 1e-7, 7u, 2u, 1000u, 1000u, 0.0, 10u, 0.9, 23u}};
...
BOOST_AUTO_TEST_CASE(miscellaneous_tests)
{
    ...
    prob.set_c_tol(1.0);
    g_aco user_algo1{100u, 13u, 1.0, 1500.0, 0.01, 90u, 1e-7, 1u, 2u, 1000u, 1000u, 1000.0, 10u, 0.9, 23u};
    user_algo1.set_verbosity(1u);
    population1 = user_algo1.evolve(population1);
    population population2{prob, 15u, 23u};
    g_aco user_algo2{100u, 13u, 1.0, 2700.0, 0.01, 90u, 1e-7, 7u, 2u, 1000u, 1000u, 0.0, 10u, 0.9, 23u};
    user_algo2.set_verbosity(1u);
    population2 = user_algo2.evolve(population2);
    population population3{prob, 15u, 23u};
    g_aco user_algo3{100u, 13u, 1.0, 1500.0, 0.01, 90u, 1e-7, 7u, 2u, 1000u, 1000u, 0.0, 10u, 0.9, 23u};
    user_algo3.set_verbosity(1u);
    population3 = user_algo3.evolve(population3);
    population population4{prob, 150u, 23u};
    g_aco user_algo4{10u, 130u, 1.5, 1500.0, 0.01, 9u, 1e-7, 7u, 2u, 1000u, 1000u, 0.0, 10u, 0.9, 23u}; // 1
    user_algo4.set_verbosity(1u);
    population4 = user_algo4.evolve(population4);
    population population5{prob, 150u, 23u};
    g_aco user_algo5{10u, 130u, 1.5, 1500.0, 0.01, 9u, 1e-7, 7u, 2u, 1000u, 1000u, 0.0, 10u, 0.9, 23u}; // 3
    ...
    g_aco user_algo6{20u, 150u, 1.0, 0.0, 0.0, 9u, 1e-7, 7u, 2u, 10000u, 10000u, 0.0, 10u, 0.9, 23u};
    ...
    g_aco user_algo7{20u, 15u, 1.0, 1e9, 0.0, 9u, -1e7, 7u, 2u, 10000u, 10000u, 0.0, 10u, 0.9, 23u}; // 3
