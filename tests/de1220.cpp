...
BOOST_AUTO_TEST_CASE(de1220_initial_population_not_respecting_bounds_throw_test)
{
    ...
    pop.set_x(0, dv);
    BOOST_CHECK_THROW(de1220{10u}.evolve(pop), std::invalid_argument);
    ...
    pop.set_x(0, dv);
    BOOST_CHECK_NO_THROW(de1220{10u}.evolve(pop));
}
