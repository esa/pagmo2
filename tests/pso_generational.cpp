...
BOOST_AUTO_TEST_CASE(evolve_test)
{
    ...
    BOOST_CHECK_THROW(pso_generational{10u}.evolve(population{problem{hock_schittkowsky_71{}}, 15u}), std::invalid_argument);
    BOOST_CHECK_THROW(pso_generational{10u}.evolve(population{problem{inventory{}}, 15u}), std::invalid_argument);
