...
BOOST_AUTO_TEST_CASE(moead_algorithm_construction)
{
    ...
    BOOST_CHECK_THROW((moead{10u, "grid", "tchebycheff", 20u, nan, 0.5, 20., 0.9, 2u, true, 23u}),
                      std::invalid_argument);
    BOOST_CHECK_THROW((moead{10u, "grid", "tchebycheff", 20u, 1., nan, 20., 0.9, 2u, true, 23u}),
                      std::invalid_argument);
    BOOST_CHECK_THROW((moead{10u, "grid", "tchebycheff", 20u, 1., 0.5, nan, 0.9, 2u, true, 23u}),
                      std::invalid_argument);
    BOOST_CHECK_THROW((moead{10u, "grid", "tchebycheff", 20u, 1., 0.5, 20., nan, 2u, true, 23u}),
                      std::invalid_argument);
}
